...
__desc__ = "Insert crawled TV schedule information into MongoDB"
...
def parseCmdLineArgs():
    ...
    parser.add_argument("--port", type=int, default=27017, dest="port",
                        help="MongoDB port")
    parser.add_argument("--schedule-files", dest="scheduleFiles",
                        type=argparse.FileType("r"), nargs="+",
                        required=True, help="schedule information file names")
